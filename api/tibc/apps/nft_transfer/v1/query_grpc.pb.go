...
const (
	Query_ClassTrace_FullMethodName  = "/tibc.apps.nft_transfer.v1.Query/ClassTrace"
	Query_ClassTraces_FullMethodName = "/tibc.apps.nft_transfer.v1.Query/ClassTraces"
)
