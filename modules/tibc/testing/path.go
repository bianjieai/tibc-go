...
func (path *Path) RelayPacket(packet packettypes.Packet, ack []byte) error {
	pc := path.EndpointA.Chain.App.IBCKeeper.Packetkeeper.GetPacketCommitment(path.EndpointA.Chain.GetContext(), packet.GetSourceChain(), packet.GetDestChain(), packet.GetSequence())
	...
	pc = path.EndpointB.Chain.App.IBCKeeper.Packetkeeper.GetPacketCommitment(path.EndpointB.Chain.GetContext(), packet.GetSourceChain(), packet.GetDestChain(), packet.GetSequence())
