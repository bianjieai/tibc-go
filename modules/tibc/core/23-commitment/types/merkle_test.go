...
func (suite *MerkleTestSuite) TestVerifyMembership() {
	...
	cases := []struct {
	...
	}{
		{
			"valid proof",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYKEY"},
			[]byte("MYVALUE"),
			func() {},
			true,
		}, // valid proof
		{
			...
			func() {},
			false,
		}, // invalid proof with wrong value
		{
			"nil value",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYKEY"},
			...
			func() {},
			false,
		}, // invalid proof with nil value
		{
			"wrong key",
			cid.Hash,
			[]string{suite.storeKey.Name(), "NOTMYKEY"},
			[]byte("MYVALUE"),
			func() {},
			false,
		}, // invalid proof with wrong key
		{
			"wrong path 1",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYKEY", "MYKEY"},
			[]byte("MYVALUE"),
			func() {},
			false,
		}, // invalid proof with wrong path
		{
			"wrong path 2",
			cid.Hash,
			[]string{suite.storeKey.Name()},
			[]byte("MYVALUE"),
			func() {},
			false,
		}, // invalid proof with wrong path
		...
		}, // invalid proof with wrong path
		{
			"wrong storekey",
			cid.Hash,
			[]string{"otherStoreKey", "MYKEY"},
			[]byte("MYVALUE"),
			func() {},
			false,
		}, // invalid proof with wrong store prefix
		{
			"wrong root",
			[]byte("WRONGROOT"),
			[]string{suite.storeKey.Name(), "MYKEY"},
		...
		}, // invalid proof with wrong root
		{
			...
			func() {},
			false,
		}, // invalid proof with nil root
		{
			"proof is wrong length",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYKEY"},
			[]byte("MYVALUE"),
			func() {
			...
			false,
		}, // invalid proof with wrong length
...
func (suite *MerkleTestSuite) TestVerifyNonMembership() {
	...
	cases := []struct {
	...
	}{
		{
			"valid proof",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYABSENTKEY"},
			func() {},
			true,
		}, // valid proof
		{
			...
			func() {},
			false,
		}, // invalid proof with existent key
		{
			"wrong path 1",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYKEY", "MYABSENTKEY"},
			func() {},
			false,
		}, // invalid proof with wrong path
		{
			"wrong path 2",
			cid.Hash,
			[]string{suite.storeKey.Name(), "MYABSENTKEY", "MYKEY"},
			func() {},
			false,
		}, // invalid proof with wrong path
		{
		...
		}, // invalid proof with wrong path
		{
			"wrong storeKey",
			cid.Hash,
			[]string{"otherStoreKey", "MYABSENTKEY"},
			func() {},
			false,
		}, // invalid proof with wrong store prefix
		{
...
func TestApplyPrefix(t *testing.T) {
	...
	require.Equal(
		t,
		"/storePrefixKey/pathone%2Fpathtwo%2Fpaththree%2Fkey",
		prefixedPath.String(),
		"Prefixed escaped path incorrect",
	)
}
...
func TestString(t *testing.T) {
	...
	require.Equal(
		t,
		"/rootKey/storeKey/path%2Fto%2Fleaf",
		path.String(),
		"path String returns unxpected value",
	)
	require.Equal(
		t,
		"/rootKey/storeKey/path/to/leaf",
		path.Pretty(),
		"path's pretty string representation is incorrect",
	)
	...
	require.Equal(
		...
		"/path%2Fto%2Fleaf",
		onePath.String(),
		"one element path does not have correct string representation",
	)
	require.Equal(
		t,
		"/path/to/leaf",
		onePath.Pretty(),
		"one element path has incorrect pretty string representation",
	)
	...
	require.Equal(
		...
		"",
		zeroPath.String(),
		"zero element path does not have correct string representation",
	)
	require.Equal(
		t,
		"",
		zeroPath.Pretty(),
		"zero element path does not have correct pretty string representation",
	)
}
