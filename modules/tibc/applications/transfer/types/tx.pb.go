...
import (
	context "context"
	fmt "fmt"
	types1 "github.com/bianjieai/tibc-go/modules/tibc/core/02-client/types"
...
func init() {
	proto.RegisterType((*MsgTransfer)(nil), "tibc.applications.transfer.v1.MsgTransfer")
	proto.RegisterType((*MsgTransferResponse)(nil), "tibc.applications.transfer.v1.MsgTransferResponse")
}
...
func (c *msgClient) Transfer(ctx context.Context, in *MsgTransfer, opts ...grpc.CallOption) (*MsgTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tibc.applications.transfer.v1.Msg/Transfer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Transfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tibc.applications.transfer.v1.Msg/Transfer",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tibc.applications.transfer.v1.Msg",
