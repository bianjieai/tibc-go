...
func init() {
	proto.RegisterType((*QueryDenomTraceRequest)(nil), "tibc.applications.transfer.v1.QueryDenomTraceRequest")
	proto.RegisterType((*QueryDenomTraceResponse)(nil), "tibc.applications.transfer.v1.QueryDenomTraceResponse")
	proto.RegisterType((*QueryDenomTracesRequest)(nil), "tibc.applications.transfer.v1.QueryDenomTracesRequest")
	proto.RegisterType((*QueryDenomTracesResponse)(nil), "tibc.applications.transfer.v1.QueryDenomTracesResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "tibc.applications.transfer.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "tibc.applications.transfer.v1.QueryParamsResponse")
}
...
func (c *queryClient) DenomTrace(ctx context.Context, in *QueryDenomTraceRequest, opts ...grpc.CallOption) (*QueryDenomTraceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tibc.applications.transfer.v1.Query/DenomTrace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomTraces(ctx context.Context, in *QueryDenomTracesRequest, opts ...grpc.CallOption) (*QueryDenomTracesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tibc.applications.transfer.v1.Query/DenomTraces", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tibc.applications.transfer.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DenomTrace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tibc.applications.transfer.v1.Query/DenomTrace",
	}
...
func _Query_DenomTraces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tibc.applications.transfer.v1.Query/DenomTraces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tibc.applications.transfer.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tibc.applications.transfer.v1.Query",
